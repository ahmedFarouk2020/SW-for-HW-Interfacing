...
void SevenSegment_Init(void)
{
	...
	GPIO_Init(PORTB, 0 , OUTPUT_PUSHPULL);// a
	GPIO_Init(PORTB, 1 , OUTPUT_PUSHPULL);// b
	GPIO_Init(PORTB, 2 , OUTPUT_PUSHPULL);// c
	GPIO_Init(PORTB, 3 , OUTPUT_PUSHPULL);// d
	GPIO_Init(PORTB, 4 , OUTPUT_PUSHPULL);// e
	GPIO_Init(PORTB, 5 , OUTPUT_PUSHPULL);// f
	GPIO_Init(PORTB, 6 , OUTPUT_PUSHPULL);// g
}
...
void SevenSegment_WriteDigit(unsigned char digit)
{
	...
	switch(Int_value)
	{
		...
		case 0:
		{
			GPIO_WritePin(PORTB, 0, 1);// a
			GPIO_WritePin(PORTB, 1, 1);// b
			GPIO_WritePin(PORTB, 2, 1);// c
			GPIO_WritePin(PORTB, 3, 1);// d
			GPIO_WritePin(PORTB, 4, 1);// e
			GPIO_WritePin(PORTB, 5, 1);// f
			GPIO_WritePin(PORTB, 6, 0);// g
		...
		case 1:
		{
			GPIO_WritePin(PORTB, 0, 0);// a
			GPIO_WritePin(PORTB, 1, 1);// b
			GPIO_WritePin(PORTB, 2, 1);// c
			GPIO_WritePin(PORTB, 3, 0);// d
			GPIO_WritePin(PORTB, 4, 0);// e
			GPIO_WritePin(PORTB, 5, 0);// f
			GPIO_WritePin(PORTB, 6, 0);// g
		...
		case 2:
		{
			GPIO_WritePin(PORTB, 0, 1);// a
			GPIO_WritePin(PORTB, 1, 1);// b
			GPIO_WritePin(PORTB, 2, 0);// c
			GPIO_WritePin(PORTB, 3, 1);// d
			GPIO_WritePin(PORTB, 4, 1);// e
			GPIO_WritePin(PORTB, 5, 0);// f
			GPIO_WritePin(PORTB, 6, 1);// g
